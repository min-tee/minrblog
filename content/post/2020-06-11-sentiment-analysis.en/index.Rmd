...
Let's illustrate TF-IDF on various mathematics books from Gutenberg.
```{r}
library(pacman)
...
#books on mathematics from project gutenberg
...
Based on bargraph, we can make following inferences:
...
Let's pick some hit songs and perform sentiment analysis with bing lexicon.The bing lexicon categorizes words in a binary fashion into positive and negative categories.
